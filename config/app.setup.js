...
async function runSetup() {
  ...
  console.log(
    chalk.red(
      figlet.textSync('Bootstrap 4 Boilerplate', { horizontalLayout: 'fitted' })
    )
  );
  ...
  fs.readFile('./config/app.config.js', 'utf8', (err, data) => {
    ...
    fs.writeFile(path.join(ROOT, '/config/app.config.js'), data, 'utf8', (err) => { });
  });
